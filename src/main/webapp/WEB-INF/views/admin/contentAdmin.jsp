...
<body>
	<div class="wrapper">
		...
		<form action="noticeUpdate?no=${notice.no}" method="post">
			<div class="contentsWrapper">
				<div class="view">
					...
					<table class="noticeView">
						...
						<th>제목: &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="50" name="subject" value="${notice.subject}"></th>
						</tr>

						<tr>
							<td>작성자:&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <input type="text" size="50" name="writer"  value="${notice.writer}">
								<br>
							</td>
						</tr>
						<tr>
							<td>내용: <br> <textarea cols="100" rows="15"
									name="content">${notice.content}</textarea> <br>
							</td>
						</tr>
